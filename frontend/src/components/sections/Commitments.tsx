...
import type { Meeting, User } from "@/data/mockData";
import type { SpeakerResolver } from "@/domain/speakers";
import type { CommitmentScope, CommitmentStatus } from "@/domain/commitments";
import { collectCommitments } from "@/domain/commitments";
import { formatAgo, formatMeetingDate } from "@/domain/datetime";
