 ...
 *
 * Real speech-to-text returns both bounds per line. The fixtures carry a start
 * only, so the end is estimated from word count and clipped to the next line's
